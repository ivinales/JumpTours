                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" aria-label="Configuración de mi cuenta">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fechaNacimiento" type="date" class="form-control @error('fechaNacimiento') is-invalid @enderror" name="fechaNacimiento" value="{{ Auth::user()->fechaNacimiento }}" required autocomplete="fechaNacimiento">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nacionalidad" type="text" class="form-control @error('nacionalidad') is-invalid @enderror" name="nacionalidad" value="{{ Auth::user()->nacionalidad }}" required autocomplete="nacionalidad">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input pattern="+[0-9]{3}+[0-9]{8}" id="telefono" type="tel" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ Auth::user()->telefono }}" required autocomplete="telefono">
                        ...
                        @else
                                    <option value="2" selected>Turista</option>
